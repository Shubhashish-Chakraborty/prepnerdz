  ...
  return (
    <div className="mt-10">
      ...
      <div
        ...
        className="w-full flex flex-col justify-center items-center font-medium mt-5 space-y-3 text-center"
      >
      ...
      <div className="w-full flex justify-center items-center text-lg gap-5 mt-10">
        ...
        <div
          style={{ fontFamily: "PPEditorialNew" }}
          className="border-[1.9px] rounded-full px-4 py-2 flex justify-center items-center gap-2 italic text-white bg-white/10 backdrop-blur-md shadow-lg"
        >
          <input
