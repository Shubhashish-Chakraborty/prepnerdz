                ...
                <div className="space-y-6 animate-fade-in-up order-2 lg:order-1 w-full lg:w-1/2">
                  <div className="space-y-4">
                    <h1 className="text-2xl md:text-4xl lg:text-4xl font-bold leading-tight">
                      <span className="text-[#ffbf23] flex md:inline-block justify-center backdrop-blur-md cursor-default rounded-3xl p-2">
                        <TypewriterEffect
                          words={["Papers?", "Notes?", "Materials?"]}
                          typeSpeed={100}
                    ...
                    <p className="text-base md:text-lg text-black md:text-start text-center max-w-2xl">
                      &apos;No more &apos;
                      <span className="font-bold">Does anyone have...?</span>
                      &apos; messages. No more dead-end{" "}
                      <span className="font-bold">Google searches.</span> Just
