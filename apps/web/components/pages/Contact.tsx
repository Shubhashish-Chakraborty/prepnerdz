  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/v1/contact/to-db`,
        formData
      );
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="w-full lg:w-2/5">
              <div className="bg-white rounded-2xl shadow-lg p-8 h-full">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold special mb-6 text-gray-800">
                    Lets Get In Touch
                  </h2>
                ...
                <div className="mb-8">
                  <h3 className="text-lg special font-semibold mb-4 text-gray-800">
                    Connect With Us
                  </h3>
            ...
            <div className="w-full lg:w-3/5">
              <div className="bg-white rounded-2xl shadow-lg p-8 h-full">
                <div className="mb-8">
                  <h2 className="text-2xl special font-bold mb-2 text-gray-800">
                    Send Us a Message
                  </h2>
                ...
                <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
                  ...
                  <ul className="text-blue-700 list-disc pl-5 space-y-1">
                    ...
                    <li>
                      We&apos;ll contact you using the email or phone number
                      provided
                    </li>
