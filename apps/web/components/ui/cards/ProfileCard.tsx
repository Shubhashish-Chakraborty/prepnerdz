...
const ProfileCard = ({ name, image, about, website, instagram, linkedin, github, mailid }: ProfileCardProps) => {
    return (
        <StyledWrapper>
            <div className="card">
                <button className="cursor-pointer mail">
                    <svg onClick={() => {window.open(website)}} fill="currentColor" stroke="currentColor" className="size-5 hover:scale-110 transition-all duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
