...
export const Navbar = () => {
  ...
  const [isMobileStudyMaterialOpen, setIsMobileStudyMaterialOpen] =
    useState(false);
  ...
  return (
    <>
      <header className="sticky top-0 z-50 w-full ">
        ...
        <nav className="w-full  border border-white/20 bg-white/10 backdrop-blur-md shadow-lg   rounded-xl flex">
          <div className="w-[15%]">
          ...
          <div className="w-[70%] flex justify-start items-center border-l-2 border-white/20">
            <div
              className="hidden lg:flex lg:items-center lg:space-x-6 xl:space-x-8"
              ref={dropdownRef}
            >
              <div className="flex items-center space-x-1 xl:space-x-2 text-white">
                <Link
                  href="/"
                  className="inline-flex h-9 w-max items-center justify-center rounded-md bg-transparent px-3 xl:px-4 py-2 text-base"
                ...
                <div className="relative">
                  <button
                    ...
                    className="cursor-pointer inline-flex h-9 w-max items-center justify-center rounded-md bg-transparent px-3 xl:px-4 py-2 text-base"
                  >
                    ...
                    <div className="absolute top-full left-0 mt-2 w-[280px] xl:w-[300px] rounded-lg border border-white/20 bg-white/95 backdrop-blur-md shadow-lg p-4 space-y-3 z-50">
                      {[
                        ...
                        },
                        {
                          title: "IMP Topics",
                          description:
                            "Get the most important topics unit wise",
                        },
                        {
          ...
          <div className="w-[15%] flex  justify-end items-center gap-10 ">
            ...
            <button
              ...
              className="bg-gradient-to-b from-[#0033A7] to-[#3096EF] px-6 py-3 text-white rounded-2xl  font-semibold text-md"
            >
              Sign in
            </button>
          </div>
          ...
          <div className="fixed right-0 top-0 h-full w-[280px] sm:w-[320px] bg-white/95 backdrop-blur-md border-l border-white/20 shadow-xl overflow-y-auto">
            <div className="flex flex-col p-4 sm:p-6 pt-16 sm:pt-20 space-y-3 sm:space-y-4">
              ...
              <div>
                <button
                  onClick={() =>
                    setIsMobileStudyMaterialOpen(!isMobileStudyMaterialOpen)
                  }
              ...
              <div>
                ...
                >
                  {"PYQ'S"}
                  <div
                    className={`transform transition-transform duration-200 ${isMobilePYQOpen ? "rotate-180" : ""}`}
                  >
                    <Down className="size-5" />
                  </div>
                </button>
