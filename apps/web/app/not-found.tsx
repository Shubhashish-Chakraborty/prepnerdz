            ...
            <div className="relative z-10">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <div className="mt-32 flex flex-col justify-center items-center bg-gradient-to-b">
                        ...
                        >
                            <p className="text-3xl md:text-6xl text-center font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent leading-tight antialiased">
                                Page Not Found
                            </p>
