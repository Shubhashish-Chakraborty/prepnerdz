...
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/cards/ContributorAvatar";
                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-20">
                            ...
                            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
                                Meet the amazing developers who are building PrepNerdz & the future of BTECH Students
                            </p>
                        ...
                        <div className="mt-32 text-center">
                            <div className="max-w-2xl mx-auto">
                                ...
                                <p className="text-lg text-muted-foreground mb-10 leading-relaxed">
                                    ...
                                    no matter how small, helps making the life of the rising engineers better!
                                </p>
