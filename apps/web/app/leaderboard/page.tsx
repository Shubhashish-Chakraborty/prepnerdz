...
const PodiumCard = ({ contributor, rank }: { contributor: Contributor; rank: number }) => {
    ...
    return (
        <Link href={`https://github.com/${contributor.username}`} target='_blank' rel="noopener noreferrer">
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="text-center mb-10 animate-leaderboard-fade-in-up">
                    ...
                    <div className='flex justify-center items-center'>
                        <Link href={'https://github.com/Shubhashish-Chakraborty/prepnerdz'} target='_blank' rel="noopener noreferrer">
                            <div className='animate-bounce cursor-pointer decoration-amber-200 hover:underline flex justify-center items-center mt-4 space-x-2'>
                                <div className="text-xl text-amber-400 font-extrabold">For PrepNerdz Project</div>
                                <div>
                                    <svg fill="currentColor" stroke="currentColor" className="size-4 text-amber-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                ...
                                {leaderboard.length === 0 ? (
                                    ...
                                    restOfLeaderboard.map((c, i) => (
                                        <tr key={c.username} className="border-t border-gray-700 hover:bg-gray-700/50">
                                            ...
                                            <Link href={`https://github.com/${c.username}`} target='_blank' rel="noopener noreferrer">
                                                <td className="px-4 py-3 flex hover:text-amber-300 items-center gap-3">
                                                    <Image src={c.avatar_url} alt={c.username} width={32} height={32} className="rounded-full" />
