...
export const metadata = {
    ...
    keywords: [
        "PrepNerdz contact", "Contact PrepNerdz", "Get in touch with PrepNerdz",
        "PrepNerdz support", "Email PrepNerdz", "Contact tech startup India",
        "Reach out PrepNerdz", "BTech help", "Student support platform",
        "PrepNerdz India", "EdTech contact", "Web development query",
        "Student platform contact", "RGPV help desk", "Startup India contact"
    ],
    openGraph: {
    ...
    twitter: {
        ...
        description: "Reach out to the team behind PrepNerdz — Let us know what you need help with.",
