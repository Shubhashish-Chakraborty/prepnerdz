...
import { privacyPolicyContent } from "./ppContent";
...
const PrivacyPolicyPage = () => {
  return (
    <>
      <Head>
        <title>Privacy Policy | PrepNerdz - Student Data Protection</title>
        <meta
          name="description"
          content="Learn how PrepNerdz protects your data. Our privacy policy explains what information we collect and how we use it to enhance your learning experience."
        />
        <meta
          name="keywords"
          content="PrepNerdz privacy, student data protection, education platform privacy, learning app security, RGPV student privacy"
        />
        ...
        <meta
          property="og:url"
          content="https://prepnerdz.tech/privacy-policy"
        />
        <meta
          property="og:title"
          content="Privacy Policy | PrepNerdz - Student Data Protection"
        />
        <meta
          property="og:description"
          content="Your privacy matters. Learn how we protect student data on PrepNerdz platform."
        />
        <meta
          property="og:image"
        ...
        <meta
          ...
          content="https://prepnerdz.tech/privacy-policy"
        />
        <meta name="twitter:title" content="Privacy Policy | PrepNerdz" />
        <meta
          name="twitter:description"
          content="Transparent information about how we protect student data on PrepNerdz platform."
        />
        <meta
          name="twitter:image"
          content="https://prepnerdz.tech/prepnerdz-only-specs.png"
        ...
        {/* Canonical URL */}
        <link rel="canonical" href="https://prepnerdz.tech/privacy-policy" />
      </Head>
          ...
          <div className="container mt-10 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="mx-auto text-center text-lg font-medium text-foreground/70">
                Last Updated At:{" "}
                <span className="text-primary">July 10, 2025</span>
              </div>
              <br />
